{
  ...
  Тема дипломного проекта \uline{Интеллектуальная система мониторинга и обеспечения безопасности путешественников}\lineunderscore \\
  ...
  \lineunderscore\\
  \uline{Диаграмма вариантов использования --- формат А1, лист 1. }\lineunderscore\\
  ...
  \uline{Главное окно пользовательского интерфейса --- формат А1, лист 1. }\lineunderscore\\
  \lineunderscore\\
