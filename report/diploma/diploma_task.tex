...
\end{center}
  ...
  Обучающемуся \uline{\hspace*{2em}}\uline{Былькову Даниилу Владимировичу}\lineunderscore \\
  {\footnotesize\hspace{9em}(фамилия, собственное имя, отчество (если таковое имеется))}\\
  
  Курс \uline{4\hspace*{2em}} Учебная группа \uline{221701}\lineunderscore\\[0.5em]
  
  Специальность \uline{1-40 03 01 Искусственный интеллект}\lineunderscore\\[0.5em]

  Тема дипломного проекта \uline{Интеллектуальная система мониторинга рисков и обеспечения безопасности путешественников}\lineunderscore \\
  ...
  Исходные данные к дипломному проекту: \uline{Сервер с предустановленной операционной системой Ubuntu Server; языки разработки Java, Python.}\lineunderscore\\[0.5em]
  \lineunderscore\\
  ...
  \uline{1 Анализ подходов к разработке}\lineunderscore\\
  \uline{2 Проектирование системы}\lineunderscore\\
  \uline{3 Разработка системы}\lineunderscore\\
  \uline{4 Технико-экономическое обоснование разработки и использования системы}\lineunderscore\\
  ...
  \lineunderscore\\
  \uline{Диаграмма компонентов системы --- формат А1, лист 1. }\lineunderscore\\
  \uline{Диаграмма развертывания системы --- формат А1, лист 1. }\lineunderscore\\
  \uline{Диаграмма последовательности обработки события --- формат А1, лист 1. }\lineunderscore\\
  \uline{Алгоритм работы модуля интеллектуального анализа событий --- формат А1, лист 1. }\lineunderscore\\
  \uline{Диаграмма классов системы --- формат А1, лист 1. }\lineunderscore\\
  \uline{Пользовательский интерфейс --- формат А1, лист 1. }\lineunderscore\\
  \lineunderscore\\

  Консультанты по дипломному проекту (с указанием разделов, по которым они консультируют): \lineunderscore\\
  \uline{Раздел 1--3 --- консультант от кафедры В. В. Захаров}\lineunderscore\\
  ...
  Примерный календарный график выполнения дипломного проекта
    ...
    \begin{tabular}{| >{\centering}m{0.05\textwidth} 
        ...
        \hline 1 & Обзор литературных источников по теме, изучение проблемной области & 10 & 09.02 -- 01.03 \\
        \hline 3 & Определение требований к реализации & 10 & 01.03 -- 10.03 \\
        \hline 4 & Проектирование модели системы & 25 & 10.03 -- 20.04 \\
        \hline 5 & Разработка системы & 30 & 21.04 -- 20.05 \\
  ...
  \begin{tabularx}{\textwidth}{@{}c c c}
    Руководитель дипломного проекта & \uline{\hspace*{6em}} & \hspace{1.2em}\uline{Д.~С.~Кисляк\hspace{3em}}\\
